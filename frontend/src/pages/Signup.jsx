...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Signup failed");
      console.log(err.response?.data); // error dekho console mein
    }
  };
      ...
      <div className="grid lg:grid-cols-2 bg-white rounded-4xl overflow-hidden shadow-2xl max-w-6xl w-full">
        ...
        <div className="hidden lg:flex flex-col justify-center bg-linear-to-br from-violet-600 to-indigo-700 text-white p-14 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl font-bold leading-tight">Join Team Workspace</h1>
            ...
            <div className="mt-10 space-y-5">
              <div className="bg-white/10 backdrop-blur-md p-5 rounded-3xl border border-white/10">
                ...
                <p className="text-violet-100 mt-2">Organize and manage team projects efficiently</p>
              </div>
              <div className="bg-white/10 backdrop-blur-md p-5 rounded-3xl border border-white/10">
                <h3 className="font-bold text-xl">👥 Team Collaboration</h3>
                <p className="text-violet-100 mt-2">Assign tasks and collaborate with team members</p>
              </div>
              <div className="bg-white/10 backdrop-blur-md p-5 rounded-3xl border border-white/10">
                <h3 className="font-bold text-xl">📊 Productivity Tracking</h3>
                <p className="text-violet-100 mt-2">Monitor progress and task completion easily</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="mb-10">
              ...
              <p className="text-gray-500 mt-3 text-lg">Signup to access your workspace</p>
            </div>
            ...
            <p className="mt-8 text-center text-gray-600 text-lg">
              ...
              <Link to="/" className="text-violet-600 font-semibold ml-2 hover:text-violet-800 transition">
                Login
              </Link>
            </p>
